...
public final class FragmentArticlesBinding implements ViewBinding {
  ...
  private FragmentArticlesBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView list,
  ...
  public static FragmentArticlesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentArticlesBinding((FrameLayout) rootView, list, progressBar);
    }
