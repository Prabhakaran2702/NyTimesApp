...
public final class ItemTabBinding implements ViewBinding {
  ...
  private ItemTabBinding(@NonNull LinearLayout rootView, @NonNull CardView cardView,
      @NonNull LinearLayout tabContainer, @NonNull TextView title) {
  ...
  public static ItemTabBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout tabContainer = (LinearLayout) rootView;
      ...
      return new ItemTabBinding((LinearLayout) rootView, cardView, tabContainer, title);
    }
